...
void main() {
    ...
    float slateblueMix = snoise(vec4(vPosition.x / 10.0, vPosition.y / 10.0, vPosition.z / 10.0, time * 0.0001)) * 0.25;
    ...
    if (whiteMix > 0.99 - sin(time * 0.0001) * 0.01) {
        finalColor = mix(finalColor, white, whiteMix);
    }
